...
# TRAINING PARAM
PROJECT_NAME="abbpcd_fashion_18B_overlap"
VOXEL_SIZE=0.008
BATCH_SIZE=4
NUM_LABELS=6
NUM_TARGETS=`expr ${NUM_LABELS} + 1`
BACKBONE="models.Res16UNet18B"
DATASETS="abbpcd_inference_custom"
TRAIN_MODE="train"
MAX_EPOCHS=600
CHECK_VAL_EVERY_N_EPOCH=10
RESUME_FROM_CKPT="./saved/${PROJECT_NAME}_benchmark/last-epoch.ckpt"    # Checkpoint for inference
