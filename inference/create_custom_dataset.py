...
def txt_create(rgb_image, depth_filtered,label, test_dir, cnt):
    ...
    rgbd = o3d.geometry.RGBDImage.create_from_color_and_depth(o3d.io.read_image(rgb_image), 
                        o3d.geometry.Image(depth_filtered),depth_scale=0.1, convert_rgb_to_intensity=False)
    
    # Change the intrinsic parameters for different camera here
    intrinsics = o3d.camera.PinholeCameraIntrinsic(width=640, height=480, fx=612.815308, fy=612.397461, cx=312.01944, cy=227.341553)
